...
describe('WikiPageService', () => {
  ...
  it('should be able to save new wiki page', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      ...
      return req.url === url &&
            req.method === 'POST' &&
             body === dummyWikiPage;
    }, 'POST to api/wiki-pages with wiki page data in json format').flush(responseWikiPage,
  ...
  it('should be able to handle rejection from server', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      ...
      return req.url === url &&
            req.method === 'POST' &&
             body === dummyWikiPage;
    }, 'POST to api/wiki-pages with wiki page data in json format').flush(null,
  ...
  it('should be able to get repository by id', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url &&
            req.method === 'GET';
    }, 'GET to api/wiki-pages/{id} with wiki page id').flush(responseWikiPage,
  ...
  it('should be able to get wiki pages by repository id', () => {
    ...
    service.getWikiPageByRepositoryId(repoId.toString()).subscribe(wikiPages => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url 
      && req.method === 'GET';
    }, 'GET to api/repositories/{id}/wiki-pages with repository id').flush(responseWikiPages,
        { status: 200, statusText: 'OK' });
