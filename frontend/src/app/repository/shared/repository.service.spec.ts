...
describe('RepositoryService', () => {
  ...
  it('should be able to get owned repositories', () => {
    ...
    return req.url === url &&
            req.method === 'GET';
    }, 'GET to api/repositories/owned').flush(responseOwnedRepositories, { status: 200, statusText: 'OK' });
  ...
  it('should be able to get contributed repositories', () => {
    ...
    return req.url === url &&
            req.method === 'GET';
    }, 'GET to api/repositories/contributed').flush(responseContributedRepositories, { status: 200, statusText: 'OK' });
  ...
  it('should be able to save new repo', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      ...
      return req.url === url &&
            req.method === 'POST' &&
             body === dummyRepo;
    }, 'POST to api/repositories with repository data in json format').flush(responseRepo,
  ...
  it('should be able to get repository by id', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url &&
            req.method === 'GET';
    }, 'GET to api/repositories/{id} with repository id').flush(responseRepo,
  ...
  it('should be able to get repository contributors by repository id', () => {
    ...
    service.getContributorsByRepositoryId(repoId.toString()).subscribe(contributors => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url 
      && req.method === 'GET';
    }, 'GET to api/repositories/{id}/contributors with repository id').flush(responseContributors,
        { status: 200, statusText: 'OK' });
  ...
  it('should be able to get repository owner by repository id', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url 
      && req.method === 'GET';
    }, 'GET to api/repositories/{id}/owner with repository id').flush(responseOwner,
        { status: 200, statusText: 'OK' });
  ...
  it('should be able to get owner and contributors by search term', () => {
    ...
    const url = `${environment.baseUrl}${repositoryUrl}/${repoId}/contributors/${term}`;

    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url 
      && req.method === 'GET';
    }, 'GET to api/repositories/{id}/contributors/{term} with repository id and search term').flush(responseUsers,
        { status: 200, statusText: 'OK' });
  ...
  it('should be able to get issues by repository id', () => {
    ...
    httpMock.expectOne((req: HttpRequest<any>) => {
      return req.url === url 
      && req.method === 'GET';
    }, 'GET to api/repositories/{id}/issues with repository id').flush(responseIssues,
        { status: 200, statusText: 'OK' });
