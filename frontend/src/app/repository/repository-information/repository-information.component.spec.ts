...
describe('RepositoryInformationComponent', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(repositoryService, 'getContributorsByRepositoryId').and.returnValue(of(contributors));
    spyOn(repositoryService, 'getOwnerByRepositoryId').and.returnValue(of(owner));
  ...
  it('should be able to get all owned repositories for that user', async(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(repositoryService.getContributorsByRepositoryId).toHaveBeenCalled();
      fixture.detectChanges();
      fixture.whenStable().then(() => {
